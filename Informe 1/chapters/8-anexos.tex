...
\section{Diagrama de consensos éticos MyAI Compass}
\label{anexo:myai_compass}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagrama_etico}
    \caption{Diagrama de consensos éticos MyAI Compass -- Equipo Charlie}
\end{figure}
