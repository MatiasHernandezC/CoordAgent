...
def prepare_verified_mention(
    ...
    if re.search(r"[^\W\d_]", raw_label, flags=re.UNICODE):
        ...
        # El hash solo sirve para crear un token interno estable. No debe
        # aparecer como si fuera el nombre de una persona (p. ej. "5000").
        # La identidad real sigue siendo el JID transportado por WhatsApp.
        display_name = "Contacto mencionado"
